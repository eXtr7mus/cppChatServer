...
#define XMLCheckResult(a_eResult) if (a_eResult != tinyxml2::XML_SUCCESS) {}
#endif
...
tinyxml2::XMLError err = doc.LoadFile("C:\\Users\\eXtr7mus\\source\\repos\\server\\server\\Config.xml");
XMLCheckResult(err);
